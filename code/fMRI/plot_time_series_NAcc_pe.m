...
% appears as Fig. 3F in Zhang & Gläscher (2020) [10.1126/sciadv.abb4159]
...
ts_dir  = fullfile('data', 'fMRI', 'time_series_NAcc');
...
load(fullfile('data', 'fMRI', 'time_series_NAcc', 'derivatives', 'onset.mat'));
load(fullfile('data', 'fMRI', 'time_series_Nacc', 'derivatives', 'model_var.mat'));

onsName = 'cuedec1_act';
pmNames = {'outcome_act', 'myValue_chn_act'};
pmLabs = {'Actual reward', 'Expected reward'};
...
ref_lw = 4; % reference Line width
ac_lw = 5;  % signal line width
