// M2b + SL (others’ current reward) -- Zhang & Gläscher (2020) [10.1126/sciadv.abb4159]
data {
  ...
  real<lower=-1.75,upper=1.75> wghtValue[nSubjects,nTrials,2]; // others' reward weighted by preference
}
